...
<link rel="stylesheet" href="./iqbil/css/privacy-policy.css" />
...
<div class="text_page">
    <p>
        ...
        and recorded by SportEase and how we use it.
    </p>
    <p>
    ...
    <p>
        SportEase follows a standard procedure of using log files. These
    ...
    <p>
        Like any other website, SportEase uses "cookies". These cookies
    ...
    <h2 class="h2">Privacy Policies</h2>
    <p>
        You may consult this list to find the Privacy Policy for each of
        the advertising partners of SportEase.
    </p>
    <p>
        Third-party ad servers or ad networks uses technologies like
        cookies, JavaScript, or Web Beacons that are used in their
        respective advertisements and links that appear on SportEase,
    ...
    <p>
        Note that SportEase has no access to or control over these
        cookies that are used by third-party advertisers.
    </p>
    <h2 class="h2">Third Party Privacy Policies</h2>
    <p>
        SportEase's Privacy Policy does not apply to other advertisers
    ...
    <p>
        SportEase does not knowingly collect any Personal Identifiable
    ...
    <h2 class="h2">Online Privacy Policy Only</h2>
    <p>
        This Privacy Policy applies only to our online activities and is
        valid for visitors to our website with regards to the
        information that they shared and/or collect in SportEase. This
