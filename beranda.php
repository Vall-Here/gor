...
<main>
  <div class="container hero" data-animated>
    <div class="hero__left">
      ...
      <p class="hero__subtitle">Lorem ipsum dolor sit amet consectetur adipiscing elit feugiat purus suscipit turpis sedvitae.</p>
    ...
    <div class="featured-fields__body">
      <?php for ($i = 0; $i < 2; $i++): ?>
        <div class="featured-fields__card" data-animated>
          <div class="featured-fields__card-left"><img alt="" src="./<?= $fields[$i]['photo'] ?>"
          ...
          <div class="featured-fields__card-right">
            <div class="featured-fields__card-top">
              <p class="featured-fields__card-location"><img alt="Location" src="./shafy/img/icons/location-gray.png">
    ...
    <div class="fields__body">
      <?php for ($i = 2; $i < 8; $i++): ?>
        <div class="fields__card" data-animated>
          <div class="fields__card-top"><img alt="" src="./<?= $fields[$i]['photo'] ?>" class="fields__card-img"> <button
    ...
    <div class="how__body">
      <div class="how__list" data-animated>
        <div class="how__item"><img alt="Step 1" src="./shafy/img/how/how-1.png" class="how__img">
          <h3 class="how__title">1. Nulla id dui sit amet sem lobortis</h3>
        ...
        <div class="how__item"><img alt="Step 1" src="./shafy/img/how/how-2.png" class="how__img">
          <h3 class="how__title">2. Fusce pellentesque ante vel dolor hendrerit</h3>
          <p class="how__description">Lorem ipsum dolor sit amet consectetur adipiscing elit odio massa ege.</p>
        </div>
        <div class="how__item"><img alt="Step 1" src="./shafy/img/how/how-3.png" class="how__img">
          <h3 class="how__title">3. Lorem ipsum dolor sit amet consectetur</h3>
          <p class="how__description">Lorem ipsum dolor sit amet consectetur adipiscing elit odio massa ege.</p>
        </div>
  ...
  <div class="container join">
    <div class="join__card join__card_partner" data-animated>
      <h2 class="join__title">List your field today</h2>
      <p class="join__description">Lorem ipsum dolor sit amet conse ctetur adipiscing elit ipsum at iaculis nulla nulla
        justo.</p><a href="./partner/login.php" class="join__button join__button_primary" data-animated>Join as a
        partner</a>
    </div>
