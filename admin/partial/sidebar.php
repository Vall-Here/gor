...
// } ?>
    ...
    <body class="body_light">
        <div class="sidebar">
            <div class="sidebar__header"><a class="sidebar__brand" href="../../gor/admin/index_admin.php"><img alt="SportEase" src="../shafy/img/sportease.png"></a><button class="sidebar__toggler"><img alt="Menu" src="../shafy/img/icons/menu.png"></button></div>
            <nav class="sidebar__body">
                <ul class="sidebar__menu-list">
                    ...
                    <li class="sidebar__menu-item"><a class="sidebar__menu-link sidebar__menu-link_collapse" href="javascript:void(0)"><img alt="Dashboard" src="../shafy/img/icons/document-black.png">Manage Lapangan<img alt="See" src="../shafy/img/icons/chevron-right-black.png"></a>
                        <ul class="sidebar__menu-list">
                            <li class="sidebar__menu-item"><a class="sidebar__menu-link" href="../../gor/admin/adminCatUpdater.php">Semua Category</a></a></li>
                    ...
                    <li class="sidebar__menu-item"><a class="sidebar__menu-link sidebar__menu-link_collapse" href="javascript:void(0)"><img alt="Dashboard" src="../shafy/img/icons/flame-black.png">Support<img alt="See" src="../shafy/img/icons/chevron-right-black.png"></a>
                        <ul class="sidebar__menu-list">
